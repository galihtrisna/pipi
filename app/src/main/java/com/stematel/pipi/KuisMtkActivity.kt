...
class KuisMtkActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Name=intent.getStringExtra(setDataSoalMtk.name)

        questionList=setDataSoalMtk.getQuestion()
            ...
            if(selecedOption!=0)
            {
                ...
                when{
                    currentPosition<=questionList!!.size->{
                        ...
                        intent.putExtra(setDataSoalMtk.name,Name.toString())
                        intent.putExtra(setDataSoalMtk.score,score.toString())
