...
class KuisIpaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Name=intent.getStringExtra(setDataSoalIpa.name)

        questionList=setDataSoalIpa.getQuestion()
            ...
            if(selecedOption!=0)
            {
                ...
                when{
                    currentPosition<=questionList!!.size->{
                        ...
                        intent.putExtra(setDataSoalIpa.name,Name.toString())
                        intent.putExtra(setDataSoalIpa.score,score.toString())
